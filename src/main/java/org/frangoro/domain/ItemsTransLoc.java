...
public class ItemsTransLoc implements java.io.Serializable {
	...
	public ItemsTransLoc(long id, String name, String status) {
		this.id = id;
		this.name = name;
		this.status = status;
	}

	public ItemsTransLoc(long id, Long parentId, String code, String name, String description, String brand,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ItemsTransLoc))
			return false;
		ItemsTransLoc castOther = (ItemsTransLoc) other;
